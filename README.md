...
Judul "Aplikasi Pengelolaan Kontak" berada di bagian atas.
Form Input:

Terdapat tiga bidang input untuk memasukkan data:
Nama: Kolom teks kosong untuk memasukkan nama kontak.
Nomor Telepon: Kolom teks kosong untuk memasukkan nomor telepon kontak.

Kategori: Dropdown yang memungkinkan pengguna memilih kategori (seperti "Keluarga", "Teman", "Kerja").
Tabel Kontak:

Sebuah tabel di sebelah kanan menampilkan daftar kontak yang sudah ada, dengan kolom berikut:
ID: Nomor identifikasi kontak.
Name: Nama kontak.
Phone: Nomor telepon kontak.
Category: Kategori kontak, misalnya "Teman".
Tombol Operasi:

Export: Untuk mengekspor data kontak.

Import: Untuk mengimpor data kontak.

Tambah Kontak: Menambahkan kontak baru.

Edit Kontak: Mengedit data kontak yang dipilih.

Hapus Kontak: Menghapus kontak yang dipilih.

Cari Kontak: Mencari kontak tertentu.
...
## coding Java Aplikasi Pengelolaan Kontak
```java
